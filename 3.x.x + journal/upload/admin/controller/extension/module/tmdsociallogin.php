...
class ControllerExtensionModuleTmdsocialLogin extends Controller {
	...
	public function index() {
		...
		$keydata=array(
		'code'=>'tmdkey_tmdsociallogin',
		'eid'=>'Mjc1MjE=',
		'route'=>'extension/module/tmdsociallogin',
		);
		$tmdsociallogin=$this->tmd->getkey($keydata['code']);
		...
		$data['fbcallback'] = $base.'index.php?route=extension/module/tmdsociallogin/fbredirecturl';

		$data['googlecallback'] =  $base.'index.php?route=extension/module/tmdsociallogin/gogleredirect';
		
		$data['twitcallback'] =  $base.'index.php';
		
		$data['linkedincallback'] =  $base.'index.php?route=extension/module/tmdsociallogin/likinredirect';
	...
	protected function validate() {
		...
		$tmdsociallogin=$this->config->get('tmdkey_tmdsociallogin');
		if (empty(trim($tmdsociallogin))) {			
		$this->session->data['warning'] ='Module will Work after add License key!';
		$this->response->redirect($this->url->link('extension/module/tmdsociallogin', 'user_token=' . $this->session->data['user_token'] . '&type=module', true));
		}
