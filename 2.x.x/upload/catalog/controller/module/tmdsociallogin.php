...
class ControllerModuletmdSociallogin extends Controller {
	public function index($setting) {
		...
		$data['fblink'] =  $helper->getLoginUrl($this->url->link('module/tmdsociallogin/fbredirecturl', '', 'SSL'),$permissions);
		}
		//Facebook  Login link code
	...
	public function fbredirecturl() {
		...
		// Include required libraries
		 ...
		 $accessToken = $helper->getAccessToken($this->url->link('module/tmdsociallogin/fbredirecturl', '', true));
	...
	public function twitredirect() {
		...
		$request_token =$connection->oauth('oauth/request_token', ['oauth_callback' => $this->url->link('module/tmdsociallogin/twitter', '', 'SSL')]);
	...
	public function likinredirect() {
		...
		$client->redirect_uri = $this->url->link('module/tmdsociallogin/likinredirect', '', true);
