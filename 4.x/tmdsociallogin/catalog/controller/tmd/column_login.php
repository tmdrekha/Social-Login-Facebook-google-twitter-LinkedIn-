...
class Columnlogin extends \Opencart\System\Engine\Controller {
	public function index(): string {
		...
		$modules = $this->model_design_layout->getModules($layout_id, 'column_login');
		...
		return $this->load->view('extension/tmdsociallogin/tmd/column_login', $data);
	}
}
