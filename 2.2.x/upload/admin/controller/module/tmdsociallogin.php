...
class ControllerModuleTmdsocialLogin extends Controller {
	...
	public function index() {
		...
		$data['fbcallback'] = $base.'index.php?route=module/tmdsociallogin/fbredirecturl';

		$data['googlecallback'] =  $base.'index.php?route=module/tmdsociallogin/gogleredirect';
		
		$data['twitcallback'] =  $base.'index.php';
		
		$data['linkedincallback'] =  $base.'index.php?route=module/tmdsociallogin/likinredirect';
	...
	protected function validate() {
		...
		$this->response->redirect($this->url->link('module/tmdsociallogin', 'token=' . $this->session->data['token'], 'SSL'));
		}
